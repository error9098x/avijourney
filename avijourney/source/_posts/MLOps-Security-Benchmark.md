...
<figure style="text-align: center; margin: 2em 0;">
  <img src="https://raw.githubusercontent.com/error9098x/avijourney/main/avijourney/static/images/mlops_pipeline_attack_surface.png" alt="MLOps pipeline diagram showing the seven stages with attacker entry points at ingestion, serving, versioning, and the LLM overlay" style="max-width: 100%; width: 880px; border-radius: 8px; box-shadow: 0 2px 12px rgba(0,0,0,0.08);" />
...
<figure style="text-align: center; margin: 2em 0;">
  <img src="https://raw.githubusercontent.com/error9098x/avijourney/main/avijourney/static/images/mlops_threat_matrix.png" alt="Per-stage threat catalog showing the primary threats for each of the seven pipeline stages" style="max-width: 100%; width: 1000px; border-radius: 8px; box-shadow: 0 2px 12px rgba(0,0,0,0.08);" />
